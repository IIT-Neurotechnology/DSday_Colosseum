...
int decouplingflag=1;
int counter=0;
#if HARDWARE_VERSION == 1
  int16_t wrapPoint = 2048; // Position used to wrap position. At 512, if position > 512 or < -512, position wraps to -512 and 512 respectively.
#else
